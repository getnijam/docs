...
"Test results" = individual test executions stored in a cycle — see
...
- Up to **1,000 test results per cycle**. When you hit the cap, further uploads are **blocked** until the
  cycle resets — your tests still run and pass/fail normally; they just aren't recorded until reset.
